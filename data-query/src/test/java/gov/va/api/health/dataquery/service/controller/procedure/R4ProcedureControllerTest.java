...
//        String json = controller().readRaw("1", "1", response);
    ...
    public void readRawSuperman() {
        ...
        DatamartProcedure dm =
                ProcedureSamples.Datamart.create().procedure("clrks-cdw-procedure", "clark", "2005-01-21T07:57:00Z");
        repository.save(asEntity(dm));
                ...
                .isEqualTo(
                        json(tempObj
                                ...
                                ProcedureSamples.R4.asBundle(
                                        ...
                                        List.of(procedure),
                                        1,
                                        link(BundleLink.LinkRelation.first, "http://fonzy.com/cool/Procedure?identifier=1", 1, 1),
                                        link(BundleLink.LinkRelation.self, "http://fonzy.com/cool/Procedure?identifier=1", 1, 1),
                                        link(
                                                BundleLink.LinkRelation.last, "http://fonzy.com/cool/Procedure?identifier=1", 1, 1))*/));
    }
...
//                                "1", dm.patient().reference().get(), dm.performedDateTime().get().toString());
    ...
    public void searchByPatientAndDateNoDates() {
        ...
        assertThat(json(tempObj /*controller().searchByPatientAndDate("p0", null, 1, 10)*/))
                .isEqualTo(
                        json(tempObj
                                /*
                                ProcedureSamples.R4.asBundle(
                                        ...
                                        link(BundleLink.LinkRelation.first, "http://fonzy.com/cool/Procedure?patient=p0", 1, 10),
                                        link(BundleLink.LinkRelation.self, "http://fonzy.com/cool/Procedure?patient=p0", 1, 10),
                                        link(BundleLink.LinkRelation.last, "http://fonzy.com/cool/Procedure?patient=p0", 1, 10))*/));
    }
    ...
    public void searchByPatientAndDateOneDate() {
        ...
        for (var date : testDates.keySet()) {
            ...
            assertThat(json(tempObj /*controller().searchByPatientAndDate("p0", new String[] {date}, 1, 10)*/))
                    .isEqualTo(
                            json(tempObj
                                    /*
                                    ProcedureSamples.R4.asBundle(
...
//        Procedure.Bundle actual = controller().searchByPatientAndDate("superman", null, 1, 1);
    ...
    public void searchByPatientWithCount0() {
        ...
        Multimap<String, Procedure> procedureByPatient = populateData();
        assertThat(json(tempObj/*controller().searchByPatientAndDate("p0", null, 1, 0)*/))
                .isEqualTo(
                        json(tempObj
                                /*
                                ProcedureSamples.R4.asBundle(
                                        ...
                                        procedureByPatient.get("p0").size(),
                                        link(BundleLink.LinkRelation.self, "http://fonzy.com/cool/Procedure?patient=p0", 1, 0))*/));
    }
