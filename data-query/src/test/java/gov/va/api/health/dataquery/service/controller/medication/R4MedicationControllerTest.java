...
public class R4MedicationControllerTest {
    ...
    public void read() {
        ...
        assertThat(json(actual)).isEqualTo(json(MedicationSamples.R4.create().medication(PUBLIC_TEST_ID)));
    }
                ...
                .isEqualTo(
                        json(
                                MedicationSamples.R4.asBundle(
                                        ...
                                        link(
                                                LinkRelation.last,
                                                "http://abed.com/cool/Medication?identifier=1",
                                                1,
                                                1))));
    }
                ...
                .isEqualTo(
                        json(
                            MedicationSamples.R4.asBundle(
                                    ...
                                    link(
                                            LinkRelation.first,
                                            "http://abed.com/cool/Medication?identifier=1", 1, 1),
                                    link(
                                            LinkRelation.self,
                                            "http://abed.com/cool/Medication?identifier=1", 1, 1),
                                    link(
