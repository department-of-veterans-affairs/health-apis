...
public class DatamartAllergyIntoleranceTest {
  public void assertReadable(String json) throws java.io.IOException {
    DatamartAllergyIntolerance dm =
        createMapper()
            .readValue(getClass().getResourceAsStream(json), DatamartAllergyIntolerance.class);
  ...
  public void unmarshalSample() {
    assertReadable("datamart-allergy-intolerance.json");
  }

  @Test
  @SneakyThrows
  public void unmarshalSampleV0() {
    assertReadable("datamart-allergy-intolerance-v0.json");
  }
}
