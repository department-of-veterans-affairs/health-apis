 ...
 */
@ControllerAdvice
public class R4MedicationRequestIncludesIcnMajig implements ResponseBodyAdvice<Object> {
  @Delegate
  private final ResponseBodyAdvice<Object> delegate =
      IncludesIcnMajig.<MedicationRequest, MedicationRequest.Bundle>builder()
