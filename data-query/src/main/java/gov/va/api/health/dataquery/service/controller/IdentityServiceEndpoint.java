...
/** This used to implement a RESTful client for interacting with a standalone Identity service. Now it just proxies to a the IdentityService implementation. */
@Component
@Endpoint(id = "ids")
